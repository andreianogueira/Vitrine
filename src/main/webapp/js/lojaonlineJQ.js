...
$(function() {
  ...
  $(".btvoltar").click(function() {
    window.location.href = 'indexBS.jsp';
  });
  $(".btvoltarcons").click(function() {
    window.location.href = 'ConsultarClienteBS.jsp';
  });
  /***********************************************************************/

  /* Sumir com todas as medidas*/
  $("#cbotamanhoroupa").hide();
  $("#tamanhonum").hide();
  $("#tamanhocalcado").hide();
  ...
  $("#formcliente").validate({ //usa o name dos campos do form
    ...
    messages: {
      ...
      inforef: {
        required: "Informe dados de referência do endereço"
      }
    },
  ...
  $("#formproduto").validate({
    ...
    messages: {
      ...
      cbotamanhoroupa: {
        required: "Informe o tamanho da roupa"
      },
      tamanhonum: {
        required: "Informe o tamanho da roupa"
      },
      tamanhosapato: {
        required: "Informe o tamanho do sapato"
      },
      valorproduto: {
        required: "Informe o valor do produto"
      },
      pagtoparcelado: {
        required: "Informe se o pagamento será parcelado"
      },
      dataproduto: {
        required: "Informe a data de início de comercialização do produto",
  ...
  $(".btnFazerPedido").click(function() {
    window.location.href = "../jsp/ConfirmarPedido.html";
  });
